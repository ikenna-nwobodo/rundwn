  ...
  return (
    <div className="md:pl-4 flex gap-4 w-max">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="grid md:artist artistnm w-[150px] h-max sm:w-[200px] sm:h-max md:w-[295px] cursor-pointer md:h-[295px] overflow-hidden md:relative place-items-center"
      >
        <img
          src={image}
          alt="pic"
          className="md:content artist-img scale-110 md:w-full w-[150px] h-[150px] sm:w-[200px] md:h-full sm:h-[200px] rounded-full md:rounded-none"
        />
