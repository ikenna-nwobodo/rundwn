...
function Track({ image, name, artist, index }) {
  ...
  return (
    <div className="flex justify-between gap-2 text-white w-full md:w-max pr-4 pl-2 py-2 border-[##ffffff4d] md:border-none bg-black bg-opacity-40 md:bg-transparent rounded-lg shadow-xl md:shadow-none">
      <p className="w-[6%] text-xl md:text-4xl md:heading text-white font-bold">
        {index}.
      </p>
      <div className="md:bg-black md:bg-opacity-40 md:p-4 flex md:flex-col gap-2 md:gap-4 w-[94%] md:w-[200px]">
        ...
        <div className="text-white">
          <p className="md:headingmid text-lg md:text-xl font-semibold md:font-medium text-wrap">
            {name}
          </p>
